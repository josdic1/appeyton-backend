...
from app.routes import (
    ...
    admin_dining_rooms, admin_tables, admin_menu_items,
...
def run_migrations():
    """Automatically syncs database schema on startup"""
    try:
...
app = FastAPI(title="Sterling Catering API", redirect_slashes=False)

# 3. CORS Configuration
# standardizes origins for dev and prod [cite: 2026-02-18]
...
async def server_error_handler(request: Request, exc: Exception):
    """Logs backend crashes while returning clean Toast notifications [cite: 2026-02-18]"""
