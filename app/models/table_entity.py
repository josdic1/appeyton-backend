...
class TableEntity(Base):
    ...
    dining_room_id: Mapped[int] = mapped_column(
        ForeignKey("dining_rooms.id"), nullable=False, index=True
    )
    ...
    def __repr__(self) -> str:
        return f"<TableEntity(room_id={self.dining_room_id}, table_number={self.table_number}, seat_count={self.seat_count})>"
